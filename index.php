    ...
    <section class="discover" id="categories">
      ...
      <div class="discover-actions">
        <div class="filters" id="filters">
          ...
          <button type="button" data-category="Sci-Fi">Sci-Fi</button>
          <button type="button" data-category="Horror">Horror</button>
          <button type="button" data-category="Thriller">Thriller</button>
          <button type="button" data-category="Action">Action</button>
          <button type="button" data-category="Romance">Romance</button>
          <button type="button" data-category="Animation">Animation</button>
        </div>
        ...
        <article class="movie-card" data-category="<?= htmlspecialchars($movie['category']) ?>" data-bg="<?= htmlspecialchars($movie['poster_url']) ?>" data-title="<?= htmlspecialchars(strtolower($movie['title'])) ?>" data-teaser="<?= htmlspecialchars($movie['teaser_url']) ?>">
          ...
          <div class="movie-info">
            ...
            <div class="movie-meta">
              ...
              <button type="button" class="watchlist-btn <?= isset($watchlistMap[(int) $movie['id']]) ? 'added' : '' ?>" data-id="<?= (int) $movie['id'] ?>">
